...
var Task = /** @class */ (function (_super) {
    ...
    Task.prototype.newNote = function () {
        ...
        row.innerHTML = "\n            <td class=\"bg-info-subtle\"><input type=\"checkbox\" class=\"task-checkbox\"></td>\n            <td class=\"bg-info-subtle text-primary\">".concat(capitalize(Task.name), "</td>\n            <td class=\"bg-info-subtle\">").concat(capitalize(this._title), "</td>\n            <td class=\"bg-info-subtle\">").concat(this._text, "</td>\n            <td class=\"bg-info-subtle\">").concat(this._location, "</td>\n            <td class=\"bg-info-subtle\">").concat(this._date.toDateString(), "</td>\n        ");
